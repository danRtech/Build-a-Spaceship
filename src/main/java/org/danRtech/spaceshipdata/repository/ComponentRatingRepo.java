...
public interface ComponentRatingRepo extends JpaRepository<ComponentRating, Integer> {
     ...
     */
    List<ComponentRating> findBySpaceshipComponentId(Integer componentId);
     ...
     */
    ComponentRating findBySpaceshipComponentIdAndPilotId(Integer componentId, Integer pilotId);
